export const LightThunderStromHailIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      ...
      <symbol id="g" overflow="visible" viewBox="0 0 398 222">
        ...
        <use xlinkHref="#i" width={350} height={222}>
          <animateTransform
            additive="sum"
            attributeName="transform"
            dur="6s"
      ...
      <symbol id="j" overflow="visible" viewBox="0 0 156.2 49">
        <g>
          <path
            fill="url(#d)"
            stroke="#86c3db"
