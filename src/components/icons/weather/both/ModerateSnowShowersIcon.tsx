export const ModerateSnowShowersIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      ...
      <symbol id="c" overflow="visible" viewBox="0 0 155.2 48">
        <g>
          <path
            fill="#86c3db"
